...
PYBIND11_MODULE(fsi_simulator, m)
{
    ...
    pybind11::class_<fsi::Simulator3D>(m, "Simulator3D")
        ...
        .def("getSamplePointIdx", &fsi::Simulator3D::getSamplePointIdx, "Get the indices of farthest sampling points")
    ...
    pybind11::class_<fsi::Simulator2D>(m, "Simulator2D")
        ...
        .def("getSamplePointIdx", &fsi::Simulator2D::getSamplePointIdx, "Get the indices of farthest sampling points")
